...
2020.5.18 准备更新新的投票模块，差额投票，可以限制投票个数，此外对于debug模式也增加密码来避免恶意

2020.5.7 1.3.1 新增了些许邮件字段，让观看邮件附件更加方便

2020.5.7 1.3.0 修正一些小错误，基本上可以正常使用

2020.5.6 1.2.9 修正投票页面出现的null的bug，新增手工打分功能
